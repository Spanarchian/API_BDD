...
[![GitHub Issues](https://img.shields.io/github/issues/anfederico/flaskex.svg)](https://github.com/KarhooColin/API_BDD/issues)
...
## Setup
``` 
git clone https://github.com/KarhooColin/API_BDD.git
cd API_BDD
